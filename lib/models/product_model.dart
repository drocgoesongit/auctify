...
class ProductUploadModel {
  ...
  factory ProductUploadModel.fromMap(Map<String, dynamic> map) {
    List<dynamic> dynamicList =
        map['categories']; // Assuming 'categories' is a List<dynamic>
    List<dynamic> dynamicListImageList = map['imageList'];

    return ProductUploadModel(
      name: map['name'] as String,
      id: map['id'] as String,
      description: map['description'] as String,
      imageList: dynamicListImageList.map((item) => item.toString()).toList(),
      categories: dynamicList.map((item) => item.toString()).toList(),
